...
class S3DISDataset(Dataset):
    def __init__(self, split='train', data_root='trainval_fullarea', num_point=4096, test_area=5, block_size=1.0, sample_rate=1.0, transform=None, num_classes=13):
        """
    ...
    def __getitem__(self, idx):
        ...
        current_points = np.zeros((self.num_point, 9))  # num_point * 9 (last three store XYZ/max(room_XYZ) aka Normalised)
