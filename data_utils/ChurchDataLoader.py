...
class ChurchDataLoader(Dataset):
    def __init__(self, root, args, split='train', process_data=False):
        ...
        assert self.num_category == 2, print(f"Expected 2 categories but found {self.num_category}")
...
if __name__ == '__main__':
    ...
    data = ChurchDataLoader('/data/modelnet40_normal_resampled/', args, split='train')
