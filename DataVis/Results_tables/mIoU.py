...
XGBoost					76.08	84.52	92.5	91.98""", """Pointnet++	31.97	31.96	31.96	31.96	31.96	31.96	31.96	31.96
...
XGBoost					80.85	85.91	95.27	91.68""", "Bagni Nerone")

church = Experiment("""Pointnet++	54.92	72.4	85.69	78.87	67.8	75.86	80.79	70.7
...
XGBoost					46.82	40.27	44.91	58.98""", """Pointnet++	53.72	60.31	75.47	78.77	68.88	68.52	67.86	70.71
...
XGBoost					43.79	39.85		58.98""", "Church")

lunnahoja = Experiment("""Pointnet++	43.8	72.74	46.08	44.65	45.39	45.53	46.08	44.65
...
XGBoost					25.84	39.61	47.98	50.82""", """Pointnet++	44.65	72.25	44.65	44.65	44.65	44.65	44.65	44.65
...
XGBoost					16.69	35.03	48.23	52.55""", "Lunnahoja")

montelupo = Experiment("""Pointnet++	59.82	59.09	82.67	85.26	73.78	51.68	75.37	83.41
...
XGBoost					31.12	69.05	86.85	90.24""", """Pointnet++	60.93	56.56	79.99	85.22	79.63	43.92	73.23	83.42
...
XGBoost					33.5	68.43	88.57	90.15""", "Montelupo")

monument = Experiment("""Pointnet++	49.79	56.34	53.04	50	49.79	52.35	51.14	50
...
XGBoost					37.73	50.49	49.98	50""", """Pointnet++	50	48.99	50	50	50	49.84	49.91	50
...
XGBoost					36.82	48.17	50	50""", "Monument")

piazza = Experiment("""Pointnet++	42.77	43.3	45.23	46.16	42.75	43.33	45.26	46.21
...
XGBoost					42.15	41.25	51.12	50.12""", """Pointnet++	46.18	46.22	46.17	46.17	46.21	46.25	46.22	46.22
...
XGBoost					43.79	41.78	48.18	50.05""", "Piazza")
