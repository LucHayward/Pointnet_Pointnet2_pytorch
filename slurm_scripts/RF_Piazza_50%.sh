...
#SBATCH --job-name="RF_Piazza_50%"
#SBATCH --mail-user=hywluc001@myuct.ac.za
#SBATCH --mail-type=ALL
#SBATCH -e slurm-RF_Piazza_50%.err
#SBATCH -o slurm-RF_Piazza_50%.out

module load python/miniconda3-py39
source activate /scratch/hywluc001/conda-envs/pointnet

cd Pointnet_Pointnet2_pytorch
python3 train_rf.py --data_path data/PatrickData/Piazza/50% --log_dir Piazza_50% --xgboost
