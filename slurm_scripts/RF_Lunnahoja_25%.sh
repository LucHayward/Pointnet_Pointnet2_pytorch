...
#SBATCH --job-name="RF_Lunnahoja_25%"
#SBATCH --mail-user=hywluc001@myuct.ac.za
#SBATCH --mail-type=ALL
#SBATCH -e slurm-RF_Lunnahoja_25%.err
#SBATCH -o slurm-RF_Lunnahoja_25%.out

module load python/miniconda3-py39
source activate /scratch/hywluc001/conda-envs/pointnet

cd Pointnet_Pointnet2_pytorch
python3 train_rf.py --data_path data/PatrickData/Lunnahoja/25% --log_dir Lunnahoja_25% --xgboost
