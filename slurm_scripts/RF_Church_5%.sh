...
#SBATCH --job-name="RF_Church_5%"
#SBATCH --mail-user=hywluc001@myuct.ac.za
#SBATCH --mail-type=ALL
#SBATCH -e slurm-RF_Church_5%.err
#SBATCH -o slurm-RF_Church_5%.out

module load python/miniconda3-py39
source activate /scratch/hywluc001/conda-envs/pointnet

cd Pointnet_Pointnet2_pytorch
python3 train_rf.py --data_path data/PatrickData/Church/5% --log_dir Church_5% --xgboost
